      ...
      <div className="container mx-auto max-w-7xl px-6 pt-32 pb-8 relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start min-h-[80vh]">
          ...
          <div className="flex flex-col justify-center text-left pt-16 lg:pt-24">
            ...
            <div className="flex flex-col gap-3 text-gray-600 mb-6">
              <div className="flex items-center gap-2">
                ...
                <span><strong>Presencial:</strong> Rua Teste, 123</span>
              </div>
              <div className="flex items-center gap-2">
                <svg className="w-5 h-5 text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex flex-col gap-4">
              <a 
                ...
                className="inline-flex items-center gap-3 bg-green-500 hover:bg-green-600 text-white px-6 py-4 rounded-full font-semibold transition-all shadow-lg hover:shadow-xl w-fit"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="inline-flex items-center gap-3 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 hover:from-purple-600 hover:via-pink-600 hover:to-orange-500 text-white px-6 py-4 rounded-full font-semibold transition-all shadow-lg hover:shadow-xl w-fit"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            {/* Credentials Card */}
            <div className="bg-white/90 backdrop-blur-sm rounded-2xl shadow-xl px-8 py-5 mt-4 text-center">
