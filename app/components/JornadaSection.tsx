      ...
      <div className="min-h-screen w-full flex px-0 overflow-hidden">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 md:px-16 lg:px-20 py-12">
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-white rounded-xl p-5 border border-border text-center shadow-sm">
              ...
              <p className="text-sm font-bold text-black mb-2">Formação de Excelência</p>
            ...
            <div className="bg-white rounded-xl p-5 border border-border text-center shadow-sm">
              ...
              <p className="text-sm font-bold text-black mb-2">Tratamentos Modernos</p>
            ...
            <div className="bg-white rounded-xl p-5 border border-border text-center shadow-sm">
              ...
              <p className="text-sm font-bold text-black mb-2">Atendimento Humanizado</p>
        ...
        <div className="hidden lg:flex w-1/2 h-full flex-col justify-center px-16 xl:px-20 py-16">
          ...
          <h3 className="text-4xl xl:text-5xl font-bold text-black tracking-tight leading-[1.1] mb-12">
