          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl">
              <div className="absolute inset-0 bg-gray-200 animate-pulse flex items-center justify-center text-gray-400">
                {/* Placeholder para foto do médico */}
                <span className="sr-only">Foto do Dr. Vitor</span>
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Trajetória e Formação</h2>
